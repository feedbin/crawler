class ProcessImage
  ...
  def perform(public_id, preset_name, original_path, original_url, candidate_urls)
    ...
    if image.valid?
      ...
      UploadImage.perform_async(public_id, @preset_name, processed_path, original_url)
    else
